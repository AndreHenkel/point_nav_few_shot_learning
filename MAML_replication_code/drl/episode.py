...
from drl.policy import weighted_mean, weighted_normalize
...
class BatchEpisodes(object):
    """
    This code was taken from: https://github.com/tristandeleu/pytorch-maml-rl/blob/243214b17da2ebfa152bba784778884b46a7e349/maml_rl/episode.py
    It is nicely done and fits my purposes
    """
    def __init__(self, batch_size, gamma=0.99, device='cpu'):
